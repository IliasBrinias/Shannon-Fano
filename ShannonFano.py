...
def shannon_fano(letters, index, start, max, dictionary):
    ...
    if first_different >= 0:
        # checks if the index was index+1
        # if the different is better, call the faction with index+1
        # if not put the 0 and 1
...
msg = 'This is a part from my exercise in my University of Piraeus'
print(msg)
letters = count_letters(msg)
...
compressed_word = compression(letters, msg)

# decompressed the msg
decompressed = decompression(letters, compressed_word)
# ------
...
print("-")
print("~DECOMPRESSED WORD~")
print(decompressed)

print("------------------------------------------------------")
print("~Statistics~")
print("1. Length Message (bit):                    ", len(compressed_word)*8)
print("2. Length compressed message (bit):         ", len(decompressed))
